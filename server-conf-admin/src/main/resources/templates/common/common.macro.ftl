...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><b>Server</b></span>
				...
				<ul class="nav navbar-nav">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
							当前环境：
								<#list envList as item>
									<#if SERVER_CONF_CURRENT_ENV == item.env>
										${item.title}(${item.env})
									</#if>
								</#list>
                    ...
                    <li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
							欢迎 ${Request["SERVER_CONF_LOGIN_IDENTITY"].username}
							<span class="caret"></span>
						</a>
                        <ul class="dropdown-menu" role="menu">
				...
				<div class="modal-body">
					<form class="form-horizontal form" role="form" >
                        <div class="form-group">
                            <label for="oldname" class="col-sm-2 control-label">旧密码<font color="red">*</font></label>
                            <div class="col-sm-10"><input type="text" class="form-control" name="oldpassword" placeholder="请输入旧密码" ></div>
                        </div>
						<div class="form-group">
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<#if Request["SERVER_CONF_LOGIN_IDENTITY"].permission == 1>
...
<#macro commonFooter >
	<footer class="main-footer">
		Powered by <b>Server-CONF</b> 1.0.0-SNAPSHOT
